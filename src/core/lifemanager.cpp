...
void
LifeManager::addMoment(const Moment& moment)
{
...
std::vector<std::reference_wrapper<const Moment>>
LifeManager::getAllMoments() const
{
...
const Moment&
LifeManager::getLastMoment() const
{
    if (moments_.empty())
...
std::vector<std::reference_wrapper<const Moment>>
LifeManager::findByType(const MomentType type) const
{
